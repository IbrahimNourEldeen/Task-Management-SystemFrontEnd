...
const Contact = () => {
  return (
    <>
      ...
      <div className=' container mb-5 mt-5 pb-5  text-center ' > <h2 className='fw-bold fs-1'>Contact Us</h2>

        <p className="fs-6   " >We'd love to hear from you! Please fill out the form below and We 'll get in touch.</p>
        ...
        <div className=' m-3 me-5'>
          <a className=' m-2' href='#'><Button style={{ backgroundColor: "#6b71e0" }} > <GrSend /> Send Message </Button></a>

          <a href='#'><Button style={{ backgroundColor: "#6b71e0" }}> <PiArrowUDownLeftBold /> Reset</Button></a>
        </div>
